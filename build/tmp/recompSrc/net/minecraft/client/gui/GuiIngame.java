...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        {
            this.renderScoreboard(scoreobjective, l, k, fontrenderer);
        }
        ...
        this.mc.mcProfiler.endSection();
        GL11.glPopMatrix();
        scoreobjective = this.mc.theWorld.getScoreboard().getObjectiveInDisplaySlot(0);
            ...
            for (i3 = 0; i3 < i2; ++i3)
            {
                ...
                if (i3 < list.size())
                {
                    ...
                    if (scoreobjective != null)
                    {
                        ...
                        if (k4 - j4 > 5)
                        {
                            Score score = scoreobjective.getScoreboard().getValueFromObjective(guiplayerinfo.name, scoreobjective);
    ...
    protected void renderInventorySlot(int p_73832_1_, int p_73832_2_, int p_73832_3_, float p_73832_4_)
    {
        ...
        if (itemstack != null)
        {
            ...
            itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRendererObj, this.mc.getTextureManager(), itemstack, p_73832_2_, p_73832_3_);
            ...
            itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRendererObj, this.mc.getTextureManager(), itemstack, p_73832_2_, p_73832_3_);
        }
    }
