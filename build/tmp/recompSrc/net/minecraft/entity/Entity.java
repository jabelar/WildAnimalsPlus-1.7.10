...
public abstract class Entity
{
    ...
    /** Appears to be a secondary offset along the y-axis */
    ...
    public void setPosition(double x, double y, double z)
    {
        ...
        this.boundingBox.setBounds(x - (double)f, y - (double)this.yOffset + (double)this.yOffset2, z - (double)f, x + (double)f, y - (double)this.yOffset + (double)this.yOffset2 + (double)f1, z + (double)f);
    }
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && flag1 && (flag || this.yOffset2 < 0.05F) && (d6 != x || d8 != z))
            {
                d12 = x;
                d10 = y;
                d11 = z;
            ...
            if (this.canTriggerWalking() && !flag && this.ridingEntity == null)
            {
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && block.getMaterial() != Material.air)
                {
                    ...
                    this.playStepSound(j1, k, l, block);
                ...
                for (int l1 = j; l1 <= i1; ++l1)
                {
                    for (int i2 = k; i2 <= j1; ++i2)
                    {
                        ...
                        catch (Throwable throwable)
                        {
                            ...
                            CrashReportCategory.addBlockInfo(crashreportcategory, k1, l1, i2, block, this.worldObj.getBlockMetadata(k1, l1, i2));
                            throw new ReportedException(crashreport);
                        }
                    }
                }
     ...
     *  
     * @param flag 0 => burning, 1 => sneaking, 2 => riding something, 3 => sprinting; 4 => eating
     */
    ...
    /**
     * Called for explosions caused by Entities instead of the method on Block. Default forwards to Block.
     */
