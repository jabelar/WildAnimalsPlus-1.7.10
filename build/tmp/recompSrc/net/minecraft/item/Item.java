...
public class Item
{
    ...
    {
        return this.getIconFromDamage(p_77650_1_.getMetadata());
    }
     ...
     */
    public Item setMaxDurability(int p_77656_1_)
    {
        this.maxDurability = p_77656_1_;
        return this;
    }

    public boolean isDamageable()
    {
        return this.maxDurability > 0 && !this.hasSubtypes;
    }
    ...
    public IIcon getIcon(ItemStack stack, int pass)
    {
         ...
         * Gets an icon index based on an item's damage value and the given render pass
         */
        return getIconFromDamageForRenderPass(stack.getMetadata(), pass);
    }
    ...
    {
        return (double)stack.getCurrentDurability() / (double)stack.getMaxDurability();
    }
    ...
    public boolean canHarvestBlock(Block par1Block, ItemStack itemStack)
    {
         ...
         * Can this Item harvest passed block
         */
        return canItemHarvestBlock(par1Block);
    }
    ...
    public static enum ToolMaterial
    {
        ...
        public ItemStack getRepairItemStack()
        {
            ...
            Item ret = this.getBaseItemForRepair();
