...
public class EntityList
{
    ...
    public static Map idToClassMap = new HashMap();
    ...
    public static void addMapping(Class p_75618_0_, String p_75618_1_, int p_75618_2_)
    {
        ...
        else if (idToClassMap.containsKey(Integer.valueOf(p_75618_2_)))
        {
        ...
        else
        {
            ...
            idToClassMap.put(Integer.valueOf(p_75618_2_), p_75618_0_);
    ...
    {
        return (Class)idToClassMap.get(Integer.valueOf(p_90035_0_));
    }
