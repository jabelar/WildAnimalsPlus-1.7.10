...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    {
        this.field_148293_a.fontRendererObj.drawString(I18n.format("lanServer.title", new Object[0]), p_148279_2_ + 32 + 3, p_148279_3_ + 1, 16777215);
        this.field_148293_a.fontRendererObj.drawString(this.field_148291_b.getServerMotd(), p_148279_2_ + 32 + 3, p_148279_3_ + 12, 8421504);

        if (this.field_148293_a.gameSettings.hideServerAddress)
        {
            this.field_148293_a.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), p_148279_2_ + 32 + 3, p_148279_3_ + 12 + 11, 3158064);
        }
        else
        {
            this.field_148293_a.fontRendererObj.drawString(this.field_148291_b.getServerIpPort(), p_148279_2_ + 32 + 3, p_148279_3_ + 12 + 11, 3158064);
        }
    }
