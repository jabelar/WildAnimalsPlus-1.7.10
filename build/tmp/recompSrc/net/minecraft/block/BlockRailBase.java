...
public abstract class BlockRailBase extends Block
{
    ...
    public void onNeighborBlockChange(World worldIn, int x, int y, int z, Block neighbor)
    {
        if (!worldIn.isRemote)
        {
            ...
            if (i1 == 2 && !World.doesBlockHaveSolidTopSurface(worldIn, x + 1, y, z))
            {
                flag = true;
            }

            if (i1 == 3 && !World.doesBlockHaveSolidTopSurface(worldIn, x - 1, y, z))
            {
                flag = true;
            }

            if (i1 == 4 && !World.doesBlockHaveSolidTopSurface(worldIn, x, y, z - 1))
            {
                flag = true;
            }

            if (i1 == 5 && !World.doesBlockHaveSolidTopSurface(worldIn, x, y, z + 1))
            {
                flag = true;
            }
            ...
            {
                this.onRedstoneSignal(worldIn, x, y, z, l, i1, neighbor);
            }
        }
    }
    ...
    public class Rail
    {
        ...
        /**
         * Rail Logic wrapper for BlockRailBase's isRailBlockAt.
         */
        private boolean isRailBlockAt(int p_150646_1_, int p_150646_2_, int p_150646_3_)
        {
            return BlockRailBase.isRailBlockAt(this.field_150660_b, p_150646_1_, p_150646_2_, p_150646_3_) ? true : (BlockRailBase.isRailBlockAt(this.field_150660_b, p_150646_1_, p_150646_2_ + 1, p_150646_3_) ? true : BlockRailBase.isRailBlockAt(this.field_150660_b, p_150646_1_, p_150646_2_ - 1, p_150646_3_));
        }
