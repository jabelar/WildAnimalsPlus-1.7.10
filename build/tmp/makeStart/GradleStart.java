...
public class GradleStart extends GradleStartCommon
{
    ...
    protected void setDefaultArguments(Map<String, String> argMap)
    {
        ...
        argMap.put("assetsDir",      "C:/Users/Aaron/.gradle/caches/minecraft/assets");
    ...
    private static void hackNatives()
    {
        ...
        String nativesDir = "C:/Users/Aaron/.gradle/caches/minecraft/net/minecraft/minecraft_natives/1.7.10";
    ...
    private void attemptLogin(Map<String, String> argMap)
    {
        ...
        argMap.put("userPropertiesMap", new GsonBuilder().registerTypeAdapter(com.mojang.authlib.properties.PropertyMap.class, new com.mojang.authlib.properties.PropertyMap.Serializer()).create().toJson(auth.getUserProperties()));
    }
