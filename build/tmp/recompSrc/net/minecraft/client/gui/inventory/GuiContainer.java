...
public abstract class GuiContainer extends GuiScreen
{
     ...
     *  
     * @param altText Should be null to display item stack size count, but can be set to show custom text where the
     * stack size counter would be.
     */
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.func_94530_a((ItemStack)null, slot))
        {
            if (isShiftKeyDown())
            {
     ...
     *  
     * @param clickType Types: 0 for basic click, 1 for shift-click, 2 for hotbar, 3 for pickBlock, 4 for drop, 5 for
     * item distribution drag, 6 for double click
     */
