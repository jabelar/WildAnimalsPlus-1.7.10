...
public class EntityFireworkSparkFX extends EntityFX
{
    ...
    public EntityFireworkSparkFX(World message, double p_i1207_2_, double p_i1207_4_, double p_i1207_6_, double p_i1207_8_, double p_i1207_10_, double p_i1207_12_, EffectRenderer p_i1207_14_)
    {
        super(message, p_i1207_2_, p_i1207_4_, p_i1207_6_);
