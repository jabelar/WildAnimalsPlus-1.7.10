...
public class RenderEnchantmentTable extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntityEnchantmentTable p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        ...
        float f1 = (float)p_147500_1_.tickCount + p_147500_8_;
        GL11.glTranslatef(0.0F, 0.1F + MathHelper.sin(f1 * 0.1F) * 0.01F, 0.0F);
        float f2;

        for (f2 = p_147500_1_.bookRotation - p_147500_1_.bookRotationPrev; f2 >= (float)Math.PI; f2 -= ((float)Math.PI * 2F))
        {
            ;
        }
        ...
        float f3 = p_147500_1_.bookRotationPrev + f2 * p_147500_8_;
        GL11.glRotatef(-f3 * 180.0F / (float)Math.PI, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(80.0F, 0.0F, 0.0F, 1.0F);
        this.bindTexture(field_147540_b);
        float f4 = p_147500_1_.pageFlipPrev + (p_147500_1_.pageFlip - p_147500_1_.pageFlipPrev) * p_147500_8_ + 0.25F;
        float f5 = p_147500_1_.pageFlipPrev + (p_147500_1_.pageFlip - p_147500_1_.pageFlipPrev) * p_147500_8_ + 0.75F;
        ...
        float f6 = p_147500_1_.bookSpreadPrev + (p_147500_1_.bookSpread - p_147500_1_.bookSpreadPrev) * p_147500_8_;
