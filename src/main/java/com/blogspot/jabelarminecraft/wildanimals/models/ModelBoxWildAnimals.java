...
public class ModelBoxWildAnimals
{
    /**
    ...
    public ModelBoxWildAnimals(ModelRendererWildAnimals par1ModelRendererWildAnimals, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10)
    {
        this.posX1 = par4;
        this.posY1 = par5;
        this.posZ1 = par6;
