...
public class ItemSkull extends Item
{
        ...
        }
        {
            if (!p_77648_3_.isRemote)
            {
                ...
                if (tileentity != null && tileentity instanceof TileEntitySkull)
                {
                    ...
                    {
                        ((TileEntitySkull)tileentity).func_152107_a(p_77648_1_.getMetadata());
                    }

                    ((TileEntitySkull)tileentity).setSkullRotation(i1);
                    ((BlockSkull)Blocks.skull).makeWither(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, (TileEntitySkull)tileentity);
                }
    ...
    {
        if (p_77653_1_.getMetadata() == 3 && p_77653_1_.hasTagCompound())
        {
            if (p_77653_1_.getTagCompound().hasKey("SkullOwner", 10))
            {
                return StatCollector.translateToLocalFormatted("item.skull.player.name", new Object[] {NBTUtil.readGameProfileFromNBT(p_77653_1_.getTagCompound().getCompoundTag("SkullOwner")).getName()});
            }
    ...
    public void registerIcons(IIconRegister register)
    {
        ...
        {
            this.field_94586_c[i] = register.registerIcon(this.getIconString() + "_" + field_94587_a[i]);
        }
    }
}