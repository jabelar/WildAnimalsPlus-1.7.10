        ...
        else
        {
            ...
            if (args.length >= 5)
            {
                ...
                try
                {
                    ...
                    {
                        notifyOperators(sender, this, "commands.give.tagError", new Object[] {"Not a valid tag"});
                        return;
                    }
                ...
                {
                    notifyOperators(sender, this, "commands.give.tagError", new Object[] {nbtexception.getMessage()});
                    return;
                }
            }
            ...
            notifyOperators(sender, this, "commands.give.success", new Object[] {itemstack.func_151000_E(), Integer.valueOf(i), entityplayermp.getCommandSenderName()});
        }
    }
