...
public class ContainerRepair extends Container
{
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (itemstack2 != null)
            {
                ...
                {
                    k = Math.min(itemstack1.getCurrentDurability(), itemstack1.getMaxDurability() / 4);
                    ...
                    {
                        i1 = itemstack1.getCurrentDurability() - k;
                        itemstack1.setMetadata(i1);
                ...
                else
                {
                    ...
                    {
                        k = itemstack.getMaxDurability() - itemstack.getCurrentDurability();
                        l = itemstack2.getMaxDurability() - itemstack2.getCurrentDurability();
                        i1 = l + itemstack1.getMaxDurability() * 12 / 100;
                        int j1 = k + i1;
                        k1 = itemstack1.getMaxDurability() - j1;
    ...
    {
        return this.theWorld.getBlock(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Blocks.anvil ? false : player.getDistanceSq((double)this.field_82861_i + 0.5D, (double)this.field_82858_j + 0.5D, (double)this.field_82859_k + 0.5D) <= 64.0D;
    }
