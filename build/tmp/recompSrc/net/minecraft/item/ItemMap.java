...
public class ItemMap extends ItemMapBase
{
    ...
    {
        String s = "map_" + p_77873_1_.getMetadata();
        MapData mapdata = (MapData)p_77873_2_.loadItemData(MapData.class, s);

        if (mapdata == null && !p_77873_2_.isRemote)
        {
            p_77873_1_.setMetadata(p_77873_2_.getUniqueDataId("map"));
            s = "map_" + p_77873_1_.getMetadata();
            mapdata = new MapData(s);
            mapdata.scale = 3;
    ...
    public Packet createMapDataPacket(ItemStack p_150911_1_, World p_150911_2_, EntityPlayer p_150911_3_)
    {
        ...
        return abyte == null ? null : new S34PacketMaps(p_150911_1_.getMetadata(), abyte);
    }
    ...
    public void onCreated(ItemStack p_77622_1_, World p_77622_2_, EntityPlayer p_77622_3_)
    {
        if (p_77622_1_.hasTagCompound() && p_77622_1_.getTagCompound().getBoolean("map_is_scaling"))
        {
            ...
            p_77622_1_.setMetadata(p_77622_2_.getUniqueDataId("map"));
            MapData mapdata1 = new MapData("map_" + p_77622_1_.getMetadata());
            ...
            mapdata1.markDirty();
            p_77622_2_.setItemData("map_" + p_77622_1_.getMetadata(), mapdata1);
        }
    }
