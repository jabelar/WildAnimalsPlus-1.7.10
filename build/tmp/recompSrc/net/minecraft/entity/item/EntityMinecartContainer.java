        ...
        for (int i = 0; i < this.getSizeInventory(); ++i)
        {
            ...
            if (itemstack != null)
            {
                ...
                while (itemstack.stackSize > 0)
                {
                    ...
                    EntityItem entityitem = new EntityItem(this.worldObj, this.posX + (double)f, this.posY + (double)f1, this.posZ + (double)f2, new ItemStack(itemstack.getItem(), j, itemstack.getMetadata()));
                    float f3 = 0.05F;
