...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        else
        {
            byte b0 = 0;
            int i = b0 + 1;
            double d0 = clamp_coord(sender, Double.NaN, args[b0]);
            double d1 = clamp_coord(sender, Double.NaN, args[i++]);
            double d2 = parseDouble(sender, args[i++], 0.0D);
            double d3 = parseDouble(sender, args[i++], d2 + 1.0D);
