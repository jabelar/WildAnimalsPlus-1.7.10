    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.message.display.incoming", new Object[] {sender.getFormattedCommandSenderName(), ichatcomponent.createCopy()});
                ChatComponentTranslation chatcomponenttranslation1 = new ChatComponentTranslation("commands.message.display.outgoing", new Object[] {entityplayermp.getFormattedCommandSenderName(), ichatcomponent.createCopy()});
