...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        public ServerList()
        {
            super(GuiIngestServers.this.mc, GuiIngestServers.this.width, GuiIngestServers.this.height, 32, GuiIngestServers.this.height - 35, (int)((double)GuiIngestServers.this.mc.fontRendererObj.FONT_HEIGHT * 3.5D));
            this.setShowSelectionBox(false);
        }

        protected int getSize()
        {
            return GuiIngestServers.this.mc.getTwitchStream().func_152925_v().length;
        }
        ...
        {
            GuiIngestServers.this.mc.gameSettings.streamPreferredServer = GuiIngestServers.this.mc.getTwitchStream().func_152925_v()[p_148144_1_].serverUrl;
        ...
        {
            return GuiIngestServers.this.mc.getTwitchStream().func_152925_v()[p_148131_1_].serverUrl.equals(GuiIngestServers.this.mc.gameSettings.streamPreferredServer);
        }
        ...
        {
            IngestServer ingestserver = GuiIngestServers.this.mc.getTwitchStream().func_152925_v()[p_148126_1_];
            String s = ingestserver.serverUrl.replaceAll("\\{stream_key\\}", "");
            String s1 = (int)ingestserver.bitrateKbps + " kbps";
            String s2 = null;
            IngestServerTester ingestservertester = GuiIngestServers.this.mc.getTwitchStream().func_152932_y();
