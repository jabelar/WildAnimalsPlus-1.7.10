...
public class ItemPotion extends Item
{
    ...
    public List getEffects(ItemStack p_77832_1_)
    {
        ...
        {
            List list = (List)this.effectCache.get(Integer.valueOf(p_77832_1_.getMetadata()));

            if (list == null)
            {
                list = PotionHelper.getPotionEffects(p_77832_1_.getMetadata(), false);
                this.effectCache.put(Integer.valueOf(p_77832_1_.getMetadata()), list);
            }
    ...
    {
        return p_82790_2_ > 0 ? 16777215 : this.getColorFromDamage(p_82790_1_.getMetadata());
    }
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_)
    {
        ...
        else
        {
            ...
            if (isSplash(p_77653_1_.getMetadata()))
            {
            ...
            {
                s1 = PotionHelper.func_77905_c(p_77653_1_.getMetadata());
