...
public class ItemColored extends ItemBlock
{
    ...
    {
        return this.field_150944_b.getRenderColor(p_82790_1_.getMetadata());
    }
    ...
    public String getUnlocalizedName(ItemStack stack)
    {
        ...
        else
        {
            ...
            return i >= 0 && i < this.field_150945_c.length ? super.getUnlocalizedName(stack) + "." + this.field_150945_c[i] : super.getUnlocalizedName(stack);
        }
    }
