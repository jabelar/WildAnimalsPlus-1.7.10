...
public class GuiBrewingStand extends GuiContainer
{
    ...
    {
        String s = this.tileBrewingStand.isCustomInventoryName() ? this.tileBrewingStand.getInventoryName() : I18n.format(this.tileBrewingStand.getInventoryName(), new Object[0]);
