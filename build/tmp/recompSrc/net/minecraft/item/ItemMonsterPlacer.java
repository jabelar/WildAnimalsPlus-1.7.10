...
public class ItemMonsterPlacer extends Item
{
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_)
    {
        ...
        String s1 = EntityList.getStringFromID(p_77653_1_.getMetadata());
    ...
    {
        EntityList.EntityEggInfo entityegginfo = (EntityList.EntityEggInfo)EntityList.entityEggs.get(Integer.valueOf(p_82790_1_.getMetadata()));
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
            ...
            Entity entity = spawnCreature(p_77648_3_, p_77648_1_.getMetadata(), (double)p_77648_4_ + 0.5D, (double)p_77648_5_ + d0, (double)p_77648_6_ + 0.5D);
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    {
                        Entity entity = spawnCreature(worldIn, itemStackIn.getMetadata(), (double)i, (double)j, (double)k);
