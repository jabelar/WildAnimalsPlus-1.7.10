...
public abstract class MapGenStructure extends MapGenBase
{
    ...
    private void func_143027_a(World p_143027_1_)
    {
        ...
        {
            this.field_143029_e = (MapGenStructureData)p_143027_1_.perWorldStorage.loadData(MapGenStructureData.class, this.getStructureName());

            if (this.field_143029_e == null)
            {
                this.field_143029_e = new MapGenStructureData(this.getStructureName());
                p_143027_1_.perWorldStorage.setData(this.getStructureName(), this.field_143029_e);
            }
            else
            {
