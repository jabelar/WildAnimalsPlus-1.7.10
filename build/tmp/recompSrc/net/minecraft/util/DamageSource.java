...
public class DamageSource
{
    ...
    public IChatComponent getDeathMessage(EntityLivingBase p_151519_1_)
    {
        ...
        String s1 = s + ".player";
        return entitylivingbase1 != null && StatCollector.canTranslate(s1) ? new ChatComponentTranslation(s1, new Object[] {p_151519_1_.getFormattedCommandSenderName(), entitylivingbase1.getFormattedCommandSenderName()}): new ChatComponentTranslation(s, new Object[] {p_151519_1_.getFormattedCommandSenderName()});
    }
